    ...
    <div class="container mx-auto px-4 max-w-5xl">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-4 border-b flex flex-wrap items-center gap-4">
                <a href="{{ route('supervisor.dashboard') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-purple-600 transition-colors">
                            ...
                            <div>
                                ...
                                <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                                    ...
                                    <div class="flex items-center">
                                        <select name="status" id="supervisor-status-{{ $task->id }}" class="block w-full pl-3 pr-10 py-2 text-sm border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 rounded-lg">
                                            <option value="assigned" {{ $status === 'assigned' ? 'selected' : '' }}>Assigned</option>
                                            <option value="in progress" {{ $status === 'in progress' ? 'selected' : '' }}>In Progress</option>
                                            <option value="completed" {{ $status === 'completed' ? 'selected' : '' }}>Completed</option>
                                            <option value="cancelled" {{ $status === 'cancelled' ? 'selected' : '' }}>Cancelled</option>
    ...
    <form action="{{ route('tasks.update.due_date', $task->id) }}" method="POST">
        ...
        <div class="flex items-center">
            ...
            <button type="submit" class="ml-2 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                ...
                <!-- Back to Dashboard -->
                <a href="{{ route('supervisor.dashboard') }}" class="block text-center bg-white rounded-xl shadow-sm py-4 px-6 text-gray-700 hover:text-purple-600 hover:bg-gray-50 transition-colors font-medium">
