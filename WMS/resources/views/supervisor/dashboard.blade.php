    ...
    <div class="flex flex-col md:flex-row items-center gap-4 mb-6">
        ...
        <div class="relative inline-block">
            ...
            >
                ...
                <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Assigned</a>
                <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">In Progress</a>
                <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Completed</a>
                <a href="#" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Over Due</a>
            </div>
        </div>
        ...
        @foreach ($projects as $project)
            ...
            <div class="project-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300" data-project-name="{{ strtolower($project->project_name) }}">
                ...
                <div class="border-t">
                    ...
                    <div class="tasks-container hidden border-t">
