    ...
    <div class="bg-gray-50 min-h-screen py-8">
        <div class="container mx-auto px-4 max-w-5xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div>
                    <!-- Back to Dashboard -->
                    <a href="{{ route('admin.dashboard') }}" class="block text-center bg-white-100 rounded-xl shadow-sm py-4 px-6 text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-colors font-medium">
