...
<div class="container mx-auto p-6 max-w-5xl">
    <div class="bg-white rounded-lg shadow-xl p-8 mb-6">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="/supervisor/dashboard" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md font-semibold text-xs text-blue-700 uppercase tracking-widest shadow-sm hover:bg-gray-200 transition ease-in-out duration-150">
        ...
        <form method="POST" action="{{ route('projects.store') }}" id="projectForm" novalidate>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div class="relative">
                    ...
                    <input type="text" name="project_name" id="project_name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" value="{{ old('project_name') }}" required>
                </div>
                ...
                <div class="relative">
                    ...
                    <select name="supervisor_name" id="supervisor_name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" required>
                        <option value="">Select Supervisor</option>
                        @foreach ($supervisors as $supervisor)
                        <option value="{{ $supervisor->first_name }}" @if (old('supervisor_name') == $supervisor->first_name) selected @endif>
            ...
            <div class="mb-8">
                ...
                <textarea name="project_description" id="project_description" rows="5" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base" required>{{ old('project_description') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div class="relative">
                    ...
                    <input type="date" name="project_date" id="project_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" value="{{ old('project_date') }}" required>
                </div>
                ...
                <div class="relative">
                    ...
                    <input type="date" name="due_date" id="due_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" value="{{ old('due_date') }}" required>
                </div>
            </div>
            ...
            <div class="mt-12 mb-8">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button type="button" class="inline-flex items-center px-5 py-3 bg-blue-500 border border-transparent rounded-md font-semibold text-sm text-white tracking-widest hover:bg-blue-600 active:bg-blue-800 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition ease-in-out duration-150" onclick="openTaskModal()">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <form id="taskForm" onsubmit="return submitTask(event)" novalidate>
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" id="task_name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" required>
                </div>
                ...
                <div>
                    ...
                    <textarea id="task_description" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base" required></textarea>
                </div>
                ...
                <div>
                    ...
                    <select id="assigned_staff" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" required>
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="date" id="assigned_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" id="task_due_date" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3" required>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select id="parent_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-base py-3">
            ...
            <div class="flex justify-end space-x-4 mt-8">
                ...
                <button type="submit" class="inline-flex items-center px-5 py-3 bg-blue-500 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest hover:bg-blue-600 active:bg-blue-800 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition ease-in-out duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                    Add Task
