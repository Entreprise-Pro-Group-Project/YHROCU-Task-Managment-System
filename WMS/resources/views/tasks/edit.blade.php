            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        ...
                        <!-- Back to Dashboard -->
                        <a href="{{ route('admin.dashboard') }}" class="block text-center bg-white rounded-xl shadow-sm py-4 px-6 text-gray-700 hover:text-blue-600 hover:bg-gray-50 transition-colors font-medium">
