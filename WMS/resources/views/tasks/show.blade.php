            ...
            <div class="bg-gray-50 min-h-screen py-8">
                ...
                @endif
                        ...
                        <!-- Right Column: Admin Actions -->
                            ...
                            <!-- Back to Dashboard -->
                            <a href="{{ route('admin.dashboard') }}" class="block text-center bg-white-100 rounded-xl shadow-sm py-4 px-6 text-gray-700 hover:text-purple-600 hover:bg-gray-50 transition-colors font-medium">
