...
<div class="bg-gray-50 min-h-screen py-8">
    ...
    @endif
                        ...
                        <!-- Add Comment Form (Supervisor) -->
                        <div class="border-t border-gray-100 pt-6">
                            <h3 class="text-base font-medium text-gray-900 mb-4">Add a supervisor comment</h3>
            ...
            <!-- Right Column: Supervisor Actions -->
                ...
                <!-- Back to Dashboard -->
                <a href="{{ route('supervisor.dashboard') }}" class="block text-center bg-white-100 rounded-xl shadow-sm py-4 px-6 text-gray-700 hover:text-purple-600 hover:bg-gray-50 transition-colors font-medium">
