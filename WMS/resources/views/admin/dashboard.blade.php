    ...
    <div class="flex flex-col md:flex-row items-center gap-4 mb-6">
        ...
        <div class="relative">
          ...
          <div id="filterDropdown" class="hidden absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-20 overflow-hidden">
            <a href="{{ route('admin.dashboard', ['status' => 'all']) }}" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 border-b border-gray-100">All Tasks</a>
            <a href="{{ route('admin.dashboard', ['status' => 'assigned']) }}" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 border-b border-gray-100">Assigned</a>
            <a href="{{ route('admin.dashboard', ['status' => 'in progress']) }}" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 border-b border-gray-100">In Progress</a>
            <a href="{{ route('admin.dashboard', ['status' => 'completed']) }}" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 border-b border-gray-100">Completed</a>
            <a href="{{ route('admin.dashboard', ['status' => 'overdue']) }}" class="block px-4 py-3 text-gray-700 hover:bg-blue-50">Over Due</a>
          </div>
        </div>
            ...
            <div class="project-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300" data-project-name="{{ strtolower($project->project_name) }}">
                ...
                <div class="border-t">
                                        ...
                                        <div class="p-3 bg-gray-50">
                                            ...
                                            <div class="flex mt-3 space-x-2">
                                                ...
                                                <form action="{{ route('tasks.destroy', $task->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this task?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="px-3 py-1 text-sm border border-red-200 text-red-500 rounded hover:bg-red-50">
                                                        Delete
                                                    </button>
                                                </form>
                                            </div>
                                                        ...
                                                        @foreach($task->subtasks as $subtask)
                                                            ...
                                                            <div class="border rounded-md p-2 text-sm">
                                                                ...
                                                                <div class="flex mt-2 space-x-2">
                                                                    ...
                                                                    <form action="{{ route('tasks.destroy', $subtask->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this subtask?');">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" class="px-2 py-1 text-xs border border-red-200 text-red-500 rounded hover:bg-red-50">
                                                                            Delete
                                                                        </button>
                                                                    </form>
                                                                </div>
                    ...
                    <div class="flex w-full border-t">
                        ...
                        <div class="w-px bg-gray-200"></div>
                        <form action="{{ route('projects.destroy', $project->id) }}" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this project?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="w-full py-2 text-center text-red-500 hover:text-red-700 hover:bg-red-50 transition-colors duration-200">
                                Delete
                            </button>
                        </form>
                    </div>
