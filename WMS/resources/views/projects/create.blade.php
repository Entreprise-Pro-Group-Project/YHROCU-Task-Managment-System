...
<div class="container mx-auto p-6 max-w-5xl">
    <div class="bg-white rounded-lg shadow-xl p-8 mb-6">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="/admin/dashboard" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md font-semibold text-xs text-blue-700 uppercase tracking-widest shadow-sm hover:bg-gray-200 transition ease-in-out duration-150">
